"""
Django settings for EStreams project.
...
SECRET_KEY = 'django-insecure-==136f0o%cnn$p!@e947*q%ftel(=uyif+=v^@tpxz1qhb!cn9'
...
WSGI_APPLICATION = 'EStreams.wsgi.application'
...
MPESA_EXPRESS_SHORTCODE = '522533'
